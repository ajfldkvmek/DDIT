				...
				<div class="col-lg-8 order-2">
					...
					<style>
  					.meet-content {
   					...
   					padding: 20px; /* 내부 여백을 추가하여 텍스트와 테두리 사이의 공백을 늘립니다. */
    				width: 800px; /* 원하는 너비를 지정합니다. */
    				border-radius: 10px; /* 모서리를 동그랗게 만듭니다. */
    				box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.1); /* 그림자를 추가하여 입체감을 부여합니다. */
  					}
					</style>
