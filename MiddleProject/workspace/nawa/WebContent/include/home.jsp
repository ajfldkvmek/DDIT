...
position: relative;
      ...
      padding: 50px;
      color: #fff;
      top: -100px; /* 원하는 만큼의 음수값을 적용해 조절하세요 */
      right: -300px; /* 원하는 만큼의 양수값을 적용해 조절하세요 */
...
<!-- =======================
Main Banner START -->
<section class="position-relative overflow-hidden pt-5 pt-lg-3 custom-section">
	<!-- SVG START -->
	...
	<div class="container">
		<!-- Title -->
		<div class="row align-items-center g-5 custom-height">
		<div class = "인덱스배경이오">
		  <img src="<%= request.getContextPath() %>/assets/images/element/인덱스화면.jpg" alt="Your Image" class="img-fluid w-100">
			</div>
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<!-- Title -->
				<div class = "콘텐츠부분이오" >
				<h1 class="mb-0 display-6" ">다양한 소모임 <br>동네친구와 함께! <br>
					<span class="position-relative">nawa!
						<!-- SVG START -->
...
<!-- Content -->
				...
				<p class="my-4 lead">우리 동네의 다양한 모임들과 레슨들을 만나볼 기회.<br> 검증된 전문 강사에게 스킬을 늘려보세요!</p>
				</div>
</div>
<!-- 인덱스 배경 밑 div끝 -->
