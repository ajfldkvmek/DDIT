...
//	private int commCountPerPage;	
	...
	private String tutorReqList;
	private int tutorReqCount;
	...
	public String getTutorReqList() {
		return tutorReqList;
	}

	public void setTutorReqList(String tutorReqList) {
		this.tutorReqList = tutorReqList;
	}

	public int getTutorReqCount() {
		return tutorReqCount;
	}

	public void setTutorReqCount(int tutorReqCount) {
		this.tutorReqCount = tutorReqCount;
	}
