...
<main>
	<section class="p-0 d-flex align-items-center position-relative overflow-hidden">
		...
		<div class="container-fluid">
			<div class="row">
				<!-- left -->
				<div class="col-12 col-lg-6 d-md-flex align-items-center justify-content-center bg-primary bg-opacity-10 vh-lg-100" style="height: 100vh;">
					<div class="p-3 p-lg-5">
						<!-- Title -->
						<div class="text-center">
							<h2 class="fw-bold">우리 동네 소모임</h2>
							<p class="mb-0 h6 fw-light">같은 취미를 공유해보자</p>
						</div>
						<!-- SVG Image -->
				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
							<!-- Title -->
							<span class="mb-0 fs-1">👋 반갑습니다</span>
							<h1 class="fs-2">  </h1>
