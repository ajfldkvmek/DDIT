...
import lecture.atch.dao.AtchFileDAOImpl;
import lecture.atch.dao.IAtchFileDAO;
import lecture.atch.vo.AtchFileVO;

public class AtchFileServiceImpl implements IAtchFileService {

	private static final String UPLOAD_DIR = "/image/lecture/";
	...
	public List<AtchFileVO> getDeatilList(long atchFileId) {
		...
		System.out.println("파일서비수ㅜㅜㅜ" + fileDAO.checkAtchFile(atchFileId));
		System.out.println("파일서비수ㅜㅜㅜ" + atchFileId);
