				...
				<div class="card bg-transparent card-body p-0">
					<div class="row d-flex justify-content-between">
						...
						<div class="col d-md-flex justify-content-between align-items-center mt-4">
							<div>
								<!-- ################################################### 여기 수정  -->
								<h1 class="my-1 fs-4"><%-- <%= 여기에 getName   %> --%> <i class="bi bi-patch-check-fill text-info small"></i></h1>
							</div>
							<!-- Button -->
						</div>
					</div>
					...
					<div class="card-body">
						...
						<form action="<%=request.getContextPath() %>/lecture/insert.do" method="post" class="row g-4" enctype="multipart/form-data">
							...
							<div class="col-12">
								...
								<textarea class="form-control" name ="lecCont" rows="20" placeholder="강의 설명"></textarea>
							</div>
 

							<!-- create button -->
							<div class="d-sm-flex justify-content-end">
								<button type="submit" class="btn btn-primary mb-0" onclick="addBtnclicked()">등록하기</button>
							</div>
						</form>
					</div>
					<!-- Card body END -->
