<%@page import="lecture.atch.vo.AtchFileVO"%>
...
<section class="pt-5 pb-0">
	<div class="container">
		<div class="row g-0 g-lg-5">
            ...
            <!-- 사진 출력부분  -->
				...
				%>
					<div>
						<img src="<%=request.getContextPath() %>/image/lecture/<%=atchVO.getStreFileNm() %>">
					</div>
					<%
						}
										}
  ...
  <li class="list-inline-item">
    <a class="btn px-2 btn-sm bg-facebook" href="#"><i class="fab fa-fw fa-facebook-f"></i></a>
  </li>
  <li class="list-inline-item">
    <a class="btn px-2 btn-sm bg-instagram-gradient" href="https://www.instagram.com/physical_gallery_egg/?hl=ko" target="_blank">
      <i class="fab fa-fw fa-instagram"></i>
    </a>
  </li>
  <li class="list-inline-item">
    <a class="btn px-2 btn-sm bg-twitter" href="#"><i class="fab fa-fw fa-twitter"></i></a>
  </li>
  <li class="list-inline-item">
    <a class="btn px-2 btn-sm bg-linkedin" href="#"><i class="fab fa-fw fa-linkedin-in"></i></a>
  </li>
</ul>
              </div>
            </div>
			...
			<div class="col-lg-8">
				...
				<style>
    			.lecture-content {
      			border: 3px solid #001; /* 테두리 스타일 및 색상을 지정합니다. */
      			padding: 10px; /* 내부 여백을 추가하여 텍스트와 테두리 사이의 공백을 지정합니다. */
     			width: 800px; /* 원하는 너비를 지정합니다. */
     			height: 400px;
     			border-radius: 10px;
				...
				<div class="row g-4 mt-4">
					<!-- Title -->
					<h2>[<%= lv.getMemName() %>] 강사의 다른 강의 리스트</h2>
                    ...
                    <div class="card shadow h-100">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <a href="#" class="badge bg-success bg-opacity-10 text-success"><%= lv.getLecGrade() %></a>
