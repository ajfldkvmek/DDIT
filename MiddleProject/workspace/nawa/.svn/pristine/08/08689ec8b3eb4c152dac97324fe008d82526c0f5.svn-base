...
#postNo, #postCate, #postWriter, #postDate, #listViewCnt, #postAtch {
text-align: center;
}
body {
...
<section class="bg-light position-relative">
  ...
  <div class="container position-relative">
    <div class="row">
      <div class="col-12">
        <div class="row align-items-center col-6" style="float: left;">
          <!-- Image -->
 ...
 -->
            ...
            <p class="mb-3">Talk about what you like with kindred spirits online</p>
            <!-- Search -->
...
<!--           <div class="col-6 col-md-3 text-center order-3"> -->
          <div class="col-6 col-md-4 text-center order-3" style="float: right;">
<%--             <img src="<%=request.getContextPath() %>/assets/images/element/category-2.svg" alt="a woman with glasses, sitting on a comfortable-looking chair"> --%>
			<img src="<%=request.getContextPath() %>/assets/images/element/04.svg" alt="a woman listening with a headphone with a notebook on her laptop and a man holding a book spread and talking">
          </div>
