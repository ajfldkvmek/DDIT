...
<%-- 							<li> <a class="dropdown-item" href="<%=request.getContextPath()%>/board/list.do">게시판!</a></li> --%>
							<li> <a class="dropdown-item" href="/nawa/board/list.do">게시판!</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							...
							<li class="dropdown-submenu dropend">
								<a class="dropdown-item dropdown-toggle" href="#">모임 검색하기</a>
...
<!-- 					Nav item 5 link
			...
			<!-- ############################################ 회원일 경우 달라질헤더 부분  ############################## -->
				...
				<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
					<img class="avatar-img rounded-circle" src="/nawa/assets/images/avatar/anno.png" alt="avatar"
					onclick="javascript:location.href='/nawa/signin.do'">
<%-- 					<img class="avatar-img rounded-circle" src="<%=request.getContextPath()%>/assets/images/avatar/anno.png" alt="avatar" --%>
<%-- 					onclick="javascript:location.href='<%=request.getContextPath()%>/signin.do'"> --%>
