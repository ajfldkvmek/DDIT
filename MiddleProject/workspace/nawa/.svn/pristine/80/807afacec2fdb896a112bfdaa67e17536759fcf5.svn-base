...
<%-- 							<li> <a class="dropdown-item" href="<%=request.getContextPath()%>/board/listNotice.do">공지사항</a></li> --%>
...
<%-- 							<li> <a class="dropdown-item" href="<%=request.getContextPath()%>/board/tutorreq.do">튜터신청</a></li> --%>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							<!-- Dropdown submenu -->
							<li>
								<a class="dropdown-item" href="<%=request.getContextPath()%>/meetList">모임 검색하기</a>
							</li>
							...
							<li>
								<a class="dropdown-item" href="#">Hero Banner</a>
							</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="accounntMenu">
							...
							<li class="dropdown-submenu dropend">
								<a class="dropdown-item dropdown-toggle" href="#"><i class="fas fa-user-tie fa-fw me-1"></i>강 사</a>
							...
							<!-- Dropdown submenu -->
								<li class="dropdown-submenu dropend">
								<a class="dropdown-item dropdown-toggle" href="#"><i class="fas fa-user-graduate fa-fw me-1"></i>학 생</a>
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="<%=request.getContextPath() %>/lecture/list.do"><i class="bi bi-grid-fill fa-fw me-1"></i>강의전체보기</a> </li>
									<li> <a class="dropdown-item" href="<%=request.getContextPath()%>/index.jsp"><i class="bi bi-card-checklist fa-fw me-1"></i>운동강의</a> </li>
					...
					<li class="px-3 mb-3">
						<div class="d-flex align-items-center">
							...
							<div class="avatar me-3">
								<img class="avatar-img rounded-circle shadow" src="/nawa/image/profile/<%=mmv.getStreFileNm() %>" alt="avatar">
							</div>
							<div>
								<a class="h6" href="#"><%=mmv.getMem_nick() %></a> 
								<p class="small m-0"><%=mmv.getMem_email() %></p> 
							</div>
						</div>
					</li>
					<li> <hr class="dropdown-divider"></li>
					<!-- Links -->
					<li><a class="dropdown-item" href="<%=request.getContextPath()%>/member/myPage.jsp"><i class="bi bi-person fa-fw me-2"></i>마이 페이지</a></li>
