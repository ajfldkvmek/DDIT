...
public class T04_ThreadTimeTest2 {
/*
     1~20억까지의 합계를 구하는데 걸린 시간 체크해 보기
     전체 합계를 구하는 작업을 단독스레드로 처리했을 때와 여러 스레드로 작업을 분할해서
     처리했을 때의 시간을 확인해 보자. 
*/
	public static void main(String[] args) {
		...
		System.out.println("단독으로 처리 할 때의 처리 시간(ms) : "
				+ (endTime - startTime));
		System.out.println();
		System.out.println();
		/////////////////////////////////////////////////
		
		// 여러 스레드로 협력해서 처리 했을 때...
		...
		System.out.println("협력 처리 했을때의 처리시간(ms) : "
				+ (endTime - startTime));
