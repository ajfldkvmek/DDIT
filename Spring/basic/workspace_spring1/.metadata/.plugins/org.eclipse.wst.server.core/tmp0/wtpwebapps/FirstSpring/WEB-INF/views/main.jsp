	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체 ${mv.boardSize }건</span>
				</div>
				<form action="" method="post">
					<div style="padding-top: 50px">
						<table class="table">
							...
							<c:set value="${mv.boardList }" var="boardList" />
							<c:choose>
			...
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체 ${mv.noticeSize }건</span>
				</div>
				<form action="" method="post">
					<div style="padding-top: 50px">
						<table class="table">
							...
							<c:set value="${mv.noticeList }" var="noticeList" />
							<c:choose>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체 ${mv.freeSize }건</span>
				</div>
				<form action="" method="post">
					<div style="padding-top: 50px">
						<table class="table">
							...
							<c:set value="${mv.freeList }" var="freeList" />
							<c:choose>
								<c:when test="${freeList} ">
									<tr>
										<td colspan="3">조회하신 게시글이 존재하지 않습니다.</td>
									</tr>
								</c:when>
								...
								<c:otherwise>
									<c:forEach items="${freeList }" var="free">
										<tr>
										<td>${free.freeNo }</td>
										<td><a href="/free/detail.do?freeNo=${free.freeNo}"}>${free.freeTitle }</a></td>								${free.freeTitle } </a></td>
										<td>${free.freeDate }</td>
										</tr>
									</c:forEach>
								</c:otherwise>
