...
$(function(){
	...
	// 아이디 입력 란에 키보드를 통해 키를 입력하고 떼는 순간 발생
	memId.keyup(function(){
		var id = $(this).val(); // 아이디를 가져온다
	...
	signupBtn.on("click", function(){
		...
		// errPrint 함수를 통해서 발생한 에러 메세지 정보를 init해준다.
		errInit();
...
function errPrint(cnt, msg, color){
	$(".error:eq("+cnt+")").text(msg).attr("color", color);
}
