    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
              ...
              <div class="card-body">
				...
				<div class="row mt-2">
				  ...
				  <div class="col-md-8">
					  ...
					  <c:if test="${member.memGender eq 'F' }">녀자</c:if>
				  </div>
				</div>
				<div class="row mt-2">
          ...
          <div class="col-md-9">
            <div class="card card-dark card-outline">
              <form class="form-horizontal" class="form-horizontal" method="post"
                     action="/notice/profileUpdate.do" id="profileUpdateForm" enctype="multipart/form-data" >
				  <div class="card-header">
				    <div class="row">
					  <div class="col-md-10">
					    <h4>내정보 수정</h4>
	                  ...
	                  <div class="tab-pane active">
	                     <input type="hidden" name="memNo" value="${member.memNo }" />
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="text" class="form-control" id="memId" value="${member.memId }" name="memId" disabled="disabled" placeholder="아이디를 입력해주세요.">
	                        </div>
	                      </div>
	                      <div class="form-group row">
	                        <label for="memPw" class="col-sm-2 col-form-label">비밀번호</label>
	                        <div class="col-sm-10">
	                          <input type="password" class="form-control" value="${member.memPw }" id="memPw" name="memPw" placeholder="비밀번호를 입력해주세요.">
	                        	</div>
	                      </div>
	                      <div class="form-group row">
	                        <label for="memName" class="col-sm-2 col-form-label">이름</label>
	                        <div class="col-sm-10">
	                          <input type="text" class="form-control" id="memName" value="${member.memName }" name="memName" placeholder="이름을 입력해주세요.">
	                        </div>
	                      </div>
						  <div class="form-group row">
							...
							<div class="col-sm-10">
							  <div class="icheck-primary d-inline">
							    <input type="radio" id="memGenderM" name="memGender" <c:if test="${member.memGender eq 'M' }">checked</c:if> value="M" checked="">
							    <label for="memGenderM">남자</label>
							  </div>
							  <div class="icheck-primary d-inline">
							    <input type="radio" id="memGenderF" <c:if test="${member.memGender eq 'F' }">checked</c:if> name="memGender" value="F">
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="text" class="form-control" id="memPhone" value="${member.memPhone }"  name="memPhone" placeholder="전화번호를 입력해주세요.">
	                        </div>
	                      </div>
