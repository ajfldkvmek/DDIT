...
<body>
	...
	<p>dateStyle속성을 short로 지정하여 문자열을 Date객체로 변환한다</p>
	...
	<p>dateStyle속성을 medium으로 지정하여 문자열을 Date객체로 변환한다</p>
