...
<body>
	...
	<p>2) @RequestParam 어노테이션을 사용하요 특정한 HTML Form의 필드명을 지정하여 요청을 처리한다.</p>
	...
	<p>6) 복수 선택이 가능한 폼 셀렉트 박스 요소 값을 문자열 배열 타입 매개변수로 처리한다.</p>
	...
	<p>1) 파일 업로드 폼 파일 요소값을 스프링MVC가 지원한 multipartFile 매개 변수로 처리
	<form action="/registerFile01" method="post" enctype="multipart/form-data">
		<input type="file" name="picture"/><br/>
		<input type="submit" name="업로드"/><br/>
	</form>
	
	<p>2) 파일 업로드 폼 파일 요소값과 텍스트필드 요소값을 스프링MVC가 지원한 multipartFile 매개 변수와 문자열 매개변수로 처리
	<form action="/registerFile02" method="post" enctype="multipart/form-data">
		userId: <input type="text" name="userId" value="Qwe"/><br/>
		password: <input type="text" name="password" value="123"/><br/>
		<input type="file" name="picture"/><br/>
		<input type="submit" name="업로드"/><br/>
	</form>
	
	<p>3) 파일 업로드 폼 파일 요소값과 텍스트필드 요소값을 스프링MVC가 지원한 multipartFile 매개 변수와 자바빈즈로 처리
	...
	<p>4) 파일 업로드 폼 파일 요소값과 텍스트필드 FileMember 타입의 자바빈즈 매개변수로 처리하기
	...
	<p>5) 여러개의 파일업로드를 폼 파일 요소값을 multipartfile로 처리
	...
	<p>6) 여러개의 파일업로드를 폼 파일 요소값을 multipartfile 타입의 요소를 가진 리스트로 처리(하게 될 경우 스프링에서는 리스트를 바인딩하지 못함)
	...
	<p>7) 여러개의 파일업로드를 폼 파일 요소값을 MultiFileMember 타입의 자바빈즈 매개변수로 처리
	...
	<p>8) 파일업로드 폼 파일 요소값과 텍스트 필드 요소값을 multipartFile타입의 배열 매개변수로 처리한다
