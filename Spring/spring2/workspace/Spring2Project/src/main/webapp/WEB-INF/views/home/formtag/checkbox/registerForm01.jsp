	...
	<form:form modelAttribute="member" method="post" action="/formtag/checkbox/result">
		...
		<table>
			...
			<tr>
				<td>취미(hobby)</td>
				<td>
					<form:checkbox path="hobby" value="Spotrs" label="Sprots"/>
			...
			<tr>
				<td>취미(hobbyArray)</td>
				<td>
					<form:checkbox path="hobbyArray" value="Spotrs" label="Sprots"/>
			...
			<tr>
				<td>취미(hobbyList)</td>
				<td>
					<form:checkbox path="hobbyList" value="Spotrs" label="Sprots"/>
