                    ...
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<%
							...
							for(MemberVO mv : memList) {
								...
								if(mv.getMem_id().equals(id)) {
									if(mv.getMem_pw().equals(pw)){
										flag = true;
										break;
									}
								}
							...
							if(flag) {
								...
								//로그인 페이지로 전달하여 "존재하지 않는 회원입니다" 에러 메세지를 출력해주세요.
								out.print("<script>alert('존재하지않는 회원입니다'); location.href='ch07_test_signin.jsp';</script>");
