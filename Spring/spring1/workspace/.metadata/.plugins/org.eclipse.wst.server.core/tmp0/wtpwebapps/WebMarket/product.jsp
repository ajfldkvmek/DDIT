...
<script>
	function addToCart(){
		if(confirm("상품을 장바구니에 추가허쉴?")){
			document.addForm.submit(); //addForm>>> 이 부분 form태그의 이름으로 설정해야함
		} else {
