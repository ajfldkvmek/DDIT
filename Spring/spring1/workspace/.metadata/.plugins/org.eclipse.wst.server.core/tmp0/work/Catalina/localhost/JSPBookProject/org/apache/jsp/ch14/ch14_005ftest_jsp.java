 ...
 * Generated at: 2024-02-07 03:39:09 UTC
...
public final class ch14_005ftest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<!-- \r\n");
      out.write("\t\t\t\t\t\t\t아이디 비밀번호를 process페이지로 넘겨 인증 처리 진행\r\n");
      out.write("\t\t\t\t\t\t\t이 떄 아이디 저장 체크를 하고 로그인 성공시 쿠키를 저장해 저장된 쿠키로 인해\r\n");
      out.write("\t\t\t\t\t\t\t다시 로그인 페이지를 reload 했을 때 아이디 저장이 체크가 되어 있고 아이디 입력란에 \r\n");
      out.write("\t\t\t\t\t\t\t아이디가 입력된 상태에 로그인 페이지가 나타나게 하기\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t아이디 저장 체크를 하지 않고 로그인 성공시 쿠키를 저장하지 않고\r\n");
      out.write("\t\t\t\t\t\t\t다시 로그인 페이지를 reload했을 때 아이디 저장이 체크가 되어 있지 않은 상태이면서 \r\n");
      out.write("\t\t\t\t\t\t\t아이디 입력란에 아이디가 입력되어 있지 않은 상태로 페이지가 나타가게 하기\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t -->\r\n");
      out.write("\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t<form action=\"ch14_test_process.jsp\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t아이디: <input type=\"text\" id=\"id\" name=\"id\" value=\"");
      out.print(cid);
      out.write("\"><br/>\r\n");
      out.write("\t\t\t\t\t\t\t비밀번호: <input type=\"text\" name=\"pw\"><br/>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"checkbox\" id=\"chk\" name=\"chk\" ");
      out.print(cchk );
      out.write(">아이디 저장<br/>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
