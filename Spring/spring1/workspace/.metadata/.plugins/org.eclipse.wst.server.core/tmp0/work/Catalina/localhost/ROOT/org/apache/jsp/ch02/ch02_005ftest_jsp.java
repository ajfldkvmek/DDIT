 ...
 * Generated at: 2024-01-24 01:07:13 UTC
...
public final class ch02_005ftest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<!-- 구구단 출력 \r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t짝수 단이면 빨간색 출력\r\n");
      out.write("\t\t\t\t\t\t\t\t출력기준은 가로 or 세로\r\n");
      out.write("\t\t\t\t\t\t\t\tselectbox제공하고 그에 따라 출력\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t-->\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<select id=\"orderSelect\">\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"\">선택</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"1\">가로</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"2\">세로</option>\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t<script>\r\n");
      out.write("\t\t$(function(){\r\n");
      out.write("\t\t\tvar orderSelect = $(\"#orderSelect\");\r\n");
      out.write("\t\t\t$(\"#t1\").hide();\r\n");
      out.write("\t\t\t$(\"#t2\").hide();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#t1\").css(\"transform\", \"scale(1)\");\r\n");
      out.write("\t\t\t$(\"#t2\").css(\"transform\", \"scale(1)\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\torderSelect.on(\"change\", function(){\r\n");
      out.write("\t\t\t\tvar value = $(this).val();\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif(value == '1'){\r\n");
      out.write("\t\t\t\t\t$(\"#t1\").show();\r\n");
      out.write("\t\t\t\t\t$(\"#t1\").css(\"transform\", \"scale(1.05)\").css(\"transition\", \".8s\");\r\n");
      out.write("\t\t\t\t\t$(\"#t2\").hide();\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$(\"#t2\").show();\r\n");
      out.write("\t\t\t\t\t$(\"#t2\").css(\"transform\", \"scale(1.05)\").css(\"transition\", \".8s\");\r\n");
      out.write("\t\t\t\t\t$(\"#t1\").hide();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t})\r\n");
      out.write("\t\t})\r\n");
